...
final class CelineBedPoseV9R3 {
    ...
    void applyBase(float[] angles, float home) {
        ...
        add(angles, HIPS, edge * -4.0f + relax * -8.0f + lie * -2.0f, 0.0f, 0.0f);
        add(angles, LEFT_UP_LEG, edge * -78.0f + relax * -52.0f + lie * -8.0f,
                0.0f, edge * 4.0f + relax * 5.0f);
        add(angles, RIGHT_UP_LEG, edge * -74.0f + relax * -48.0f + lie * -6.0f,
                0.0f, edge * -5.0f + relax * -4.0f);
        add(angles, LEFT_LEG, edge * 88.0f + relax * 58.0f + lie * 10.0f, 0.0f, 0.0f);
        add(angles, RIGHT_LEG, edge * 84.0f + relax * 54.0f + lie * 8.0f, 0.0f, 0.0f);
    ...
    void applyPosture(float[] angles, float home) {
        ...
        float relax = home * smooth(relaxBlend);
        float lie = home * smooth(lieBlend);
        add(angles, SPINE, edge * 3.0f + relax * 8.0f + lie * 2.0f, 0.0f, 0.0f);
        add(angles, SPINE01, edge * 4.0f + relax * 10.0f + lie * 3.0f, 0.0f, 0.0f);
        add(angles, SPINE02, edge * 3.0f + relax * 8.0f + lie * 2.0f, 0.0f, 0.0f);
        add(angles, NECK, relax * -3.0f + lie * -5.0f, lie * -5.0f, 0.0f);
        add(angles, LEFT_SHOULDER, 0.0f, 0.0f, relax * -3.0f + lie * -7.0f);
        add(angles, RIGHT_SHOULDER, 0.0f, 0.0f, relax * 3.0f + lie * 7.0f);
        add(angles, LEFT_ARM, relax * -10.0f + lie * -16.0f, 0.0f,
                relax * 12.0f + lie * 18.0f);
        add(angles, RIGHT_ARM, relax * -8.0f + lie * -14.0f, 0.0f,
                relax * -12.0f + lie * -18.0f);
        add(angles, LEFT_FOREARM, relax * -18.0f + lie * -10.0f, 0.0f, 0.0f);
        add(angles, RIGHT_FOREARM, relax * -16.0f + lie * -9.0f, 0.0f, 0.0f);
    }
