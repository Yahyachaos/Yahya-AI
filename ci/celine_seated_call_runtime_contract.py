...
if "versionCode 73" not in build:
    raise SystemExit("v73 versionCode gate missing while preserving v70 seated CALL")
...
print("v70 CALL-only seated lower body + behind-Filament chair preserved in v73: PASS")
